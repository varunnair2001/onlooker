...
class AnimatedText extends Object3D {
    constructor(text, font, { size = 0.15, letterSpacing = 0.03, color = '#000000' } = {}) {
        super();
...
setTimeout(() => {
    const text = new AnimatedText('', fontAsset);
    text.position.x -= text.basePosition * 5;
    text.position.y -= -4.2;
    webgl.add(text);
    text.show();
    const text1 = new AnimatedText('', fontAsset);
    text1.position.x -= text.basePosition * 3;
    text1.position.y -= -4.2;
    webgl.add(text1);
    text1.show();
    const text2 = new AnimatedText('', fontAsset);
    text2.position.x -= text.basePosition * -1.2;
    text2.position.y -= -4.2;
    webgl.add(text2);
    text2.show();
    const text3 = new AnimatedText('', fontAsset);
    text3.position.x -= text.basePosition * -3.2;
    text3.position.y -= -4.2;
    webgl.add(text3);
    text3.show();
}, 1000);
